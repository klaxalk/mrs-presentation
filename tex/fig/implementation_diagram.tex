...
\begin{tikzpicture}[->,>=stealth', node distance=7.0em]
  ...
  \node[state, shift = {(0.0em, 0.0em)}] (uav_manager) {
      \begin{tabular}{c}
        \small UAV manager
      \end{tabular}
    };

  \node[state, below of = uav_manager, shift = {(0.0em, -0.0em)}] (control_manager) {
      \begin{tabular}{c}
  ...
  \node[state, above of = so3_controller, shift = {(0.0em, -2.0em)}] (gain_manager) {
      \begin{tabular}{c}
        \small Gain manager
      \end{tabular}
    };
  ...
  \node[state, above of = landoff_tracker, shift = {(0.0em, -2.0em)}] (constraint_manager) {
      \begin{tabular}{c}
        \small Constraint manager
      \end{tabular}
    };

  \node[state, below of = control_manager, shift = {(0.0em, -6.0em)}] (odometry) {
      \begin{tabular}{c}
        \small Odometry
      \end{tabular}
    };
  ...
  \node[state, above of = realsense, shift = {(0.0em, -3.5em)}] (orb_slab) {
    ...
    \path[-] ($(mavros_interface.north)$) edge [->] ($(odometry.south)$);
    \path[-] ($(garmin.north)$) edge [->] ($(odometry.south)$);
    \path[-] ($(rplidar.north)$) edge [->] ($(odometry.south)$);
    \path[-] ($(optic_flow.north)$) edge [->] ($(odometry.south)$);
    \path[-] ($(realsense.north)$) edge [->] ($(odometry.south)$);
    \path[-] ($(orb_slab.west)$) edge [->] ($(odometry.south)$);
    ...
    \path[-] ($(attitude_controller.east)$) edge [->] ($(control_manager.west)$);
    \path[-] ($(nsf_controller.east)$) edge [->] ($(control_manager.west)$);
    \path[-] ($(failsafe_controller.east)$) edge [->] ($(control_manager.west)$);
    \path[-] ($(mpc_controller.east)$) edge [->] ($(control_manager.west)$);
    \path[-] ($(so3_controller.east)$) edge [->] ($(control_manager.west)$);

    %% | ------ connections from trackers to control manager ------ |
    \path[-] ($(landoff_tracker.west)$) edge [->] ($(control_manager.east)$);
    \path[-] ($(mpc_tracker.west)$) edge [->] ($(control_manager.east)$);
    \path[-] ($(joy_tracker.west)$) edge [->] ($(control_manager.east)$);
    \path[-] ($(matlab_tracker.west)$) edge [->] ($(control_manager.east)$);
    \path[-] ($(csv_tracker.west)$) edge [->] ($(control_manager.east)$);

    %% | ------------------- gain manager to so3 ------------------ |
    \path[-] ($(gain_manager.south)$) edge [->] ($(so3_controller.north)$);

    %% | ---------- constraint manager to control manager --------- |
    \draw[<->] ($(constraint_manager.west)$) -- ($(control_manager.north |- constraint_manager.east) + (2em, 0)$) |- ($(control_manager.north)$);
    \draw[] ($(gain_manager.east)$) -- ($(control_manager.north |- constraint_manager.east) + (-1em, 0)$) |- ($(control_manager.north) + (-1em, 0)$);
    ...
    \path[-] ($(bumper.east)$) edge [->] ($(control_manager.south) + (-2em, 0)$);
