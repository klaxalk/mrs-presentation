...
\begin{frame}
  ...
  \only<+>{\begin{block}{Embedded Model Predictive Control}
      \begin{center}
        \movie[autostart]{
          \includegraphics[width=0.9\textwidth]{./fig/mmar_vojta_thumbnail.jpg}
        }{../videos/mmar_vojta.mp4}\\
        Video: \url{https://youtu.be/9Bpm4J31CgE}
      \end{center}
  \end{block}}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \onslide<4->{\item ...}
    \onslide<5->{\item Not Scalable! Bottlenecks everywhere: Embedded programming \emph{sucks}, simulations are difficult, system is hard to maintain, connecting sensors and peripheries is limited...}
    \onslide<6->{\item ... 2015}
\end{itemize}
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \frametitle{Control -- implementation PoV}

    \only<+>{
      \vspace{-1.5em}
      \begin{adjustbox}{max totalsize={1.0\textwidth}{.95\textheight}, center}
    ...
    \only<+>{
      \frametitle{Control -- implementation PoV}
      \vspace{-1em}
      \begin{adjustbox}{max totalsize={0.95\textheight}{.65\textwidth}, angle=90}
        \input{fig/implementation_diagram.tex}
      \end{adjustbox}
    }
    ...
    \only<+>{
      \vspace{-1.5em}
      \begin{adjustbox}{max totalsize={1.0\textwidth}{.95\textheight}, center}
        \input{fig/implementation_diagram_odom.tex}
      \end{adjustbox}
    }
    ...
    \only<+>{
      \vspace{-1.5em}
      \begin{adjustbox}{max totalsize={1.0\textwidth}{.95\textheight}, center}
        \input{fig/implementation_diagram_control.tex}
      \end{adjustbox}
    }
    ...
    \only<+>{
      \vspace{-1.0em}
      \begin{adjustbox}{max totalsize={1.0\textwidth}{.95\textheight}, center}
        \input{fig/implementation_diagram_control_2.tex}
      \end{adjustbox}
    }
    ...
    \only<+>{
      \vspace{-1.0em}
      \begin{adjustbox}{max totalsize={1.0\textwidth}{.95\textheight}, center}
        \input{fig/implementation_diagram_control_3.tex}
      \end{adjustbox}
    }
    ...
    \only<+>{
      \vspace{-1.5em}
      \begin{adjustbox}{max totalsize={1.0\textwidth}{.95\textheight}, center}
        \input{fig/implementation_diagram_last.tex}
      \end{adjustbox}
    }
...
%%{ Software tools in our disposal
\begin{frame}
